				...
				<div class="panel-body">		
					<form class="form-horizontal" id="loginform" action="" method="POST">
						<div class="form-group form-group-sm">
							...
							<div class="col-sm-8">
								<input type="text" id="Name" name="t1" placeholder="Enter user Name" required class="form-control" autofocus>
							</div>
						</div>
						<div class="form-group form-group-sm">
							<label class="col-sm-3 control-label" for="Roll_Num">Password:</label>
							<div class="col-sm-8">
								<input type="password" id="Roll" name="t2" placeholder="Enter Password" required class="form-control" autofocus>
							</div>
						</div>
